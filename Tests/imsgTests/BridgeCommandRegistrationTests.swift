...
func injectedHelperRefusesSymlinkGroupPhotoPaths() throws {
  ...
  // send-attachment already refuses symlink components before copyItemAtURL.
  // Group-photo updates use the same transfer helper; empty filePath still
  // clears the photo and must stay allowed.
